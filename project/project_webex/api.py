...
current_access_token = "NjQxOTNmZWQtZGFkNy00NmRjLTg4Y2UtN2YzYjIwZTY0Y2E1YTRhM2E0MDYtNWI3_P0A1_5d6a13c3-cd60-473d-a264-caff0c1a43a6" ### add your own bearer token
...
def main2(): # using rest api
    ...
    with open ('/home/devasc/labs/devnet-src/project/project_webex/groups_struc.json') as json_file:
